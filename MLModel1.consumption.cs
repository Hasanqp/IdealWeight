...
namespace IdealWeight
{
    public partial class MLModel1
    {
        ...
        public class ModelInput
        {
            ...
            public float PhysicalActivityLevel { get; set; }

            [LoadColumn(6)]
            [ColumnName(@"ObesityCategory")]
            public string ObesityCategory { get; set; }
        ...
        public class ModelOutput
        {
            ...
            [ColumnName(@"ObesityCategory")]
            public uint ObesityCategory { get; set; }
        ...
        private static IEnumerable<string> GetLabels(ModelOutput result)
        {
            ...
            var labelColumn = schema.GetColumnOrNull("ObesityCategory");
            if (labelColumn == null)
            {
                throw new Exception("ObesityCategory column not found. Make sure the name searched for matches the name in the schema.");
            }
